...
DOMAIN = "mail_and_packages_v2"  # Changed domain for v2
DOMAIN_DATA = f"{DOMAIN}_data"
VERSION = "2.0.0-dev"
ISSUE_URL = "http://github.com/moralmunky/Home-Assistant-Mail-And-Packages" # Should be updated if repo changes
PLATFORM = "sensor"
PLATFORMS = ["camera", "sensor"]
DATA = "data"
COORDINATOR = "coordinator_mail_v2" # Changed for v2
...
ATTR_FULL_EMAIL_CONTENT = "full_email_content" # New for V2
...
CONF_IMAGE_SECURITY = "image_security" # May be deprecated or re-evaluated
CONF_IMAP_TIMEOUT = "imap_timeout"
CONF_GENERATE_MP4 = "generate_mp4"
CONF_AMAZON_FWDS = "amazon_fwds"
CONF_AMAZON_DAYS = "amazon_days"
CONF_STORE_FULL_EMAIL = "store_full_email_content" # New for V2

# Defaults
DEFAULT_CAMERA_NAME = "Mail USPS Camera V2" # Changed for V2
DEFAULT_NAME = "Mail And Packages V2" # Changed for V2
DEFAULT_PORT = "993"
DEFAULT_FOLDER = '"INBOX"'
DEFAULT_PATH = "custom_components/mail_and_packages_v2/images/" # Changed for V2
...
DEFAULT_CUSTOM_IMG_FILE = "custom_components/mail_and_packages_v2/images/mail_none.gif" # Changed for V2
DEFAULT_AMAZON_DAYS = 3
DEFAULT_STORE_FULL_EMAIL = False # New for V2
...
# Sensor Data (This will likely need significant review/updates for V2)
SENSOR_DATA = {
    # USPS
    "usps_delivered": {
...
# Sensor definitions
# These will need to be updated for V2, potentially with new icons or names
SENSOR_TYPES: Final[dict[str, SensorEntityDescription]] = {
    "mail_updated": SensorEntityDescription(
        name="Mail Updated V2", # Changed for V2
        icon="mdi:update",
        key="mail_updated",
    ...
    "ups_delivered": SensorEntityDescription(
        name="Mail UPS Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="ups_delivered",
    ),
    "ups_delivering": SensorEntityDescription(
        name="Mail UPS Delivering V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
        key="ups_delivering",
    ),
    "ups_exception": SensorEntityDescription(
        name="Mail UPS Exception V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:archive-alert",
        key="ups_exception",
    ),
    "ups_packages": SensorEntityDescription(
        name="Mail UPS Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="ups_packages",
    ),
    ...
    "fedex_delivered": SensorEntityDescription(
        name="Mail FedEx Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="fedex_delivered",
    ),
    "fedex_delivering": SensorEntityDescription(
        name="Mail FedEx Delivering V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
        key="fedex_delivering",
    ),
    "fedex_packages": SensorEntityDescription(
        name="Mail FedEx Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="fedex_packages",
    ),
    ...
    "amazon_packages": SensorEntityDescription(
        name="Mail Amazon Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package",
        key="amazon_packages",
    ),
    "amazon_delivered": SensorEntityDescription(
        name="Mail Amazon Packages Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="amazon_delivered",
    ),
    "amazon_exception": SensorEntityDescription(
        name="Mail Amazon Exception V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:archive-alert",
        key="amazon_exception",
    ),
    "amazon_hub": SensorEntityDescription(
        name="Mail Amazon Hub Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package",
        key="amazon_hub",
    ),
    ...
    "capost_delivered": SensorEntityDescription(
        name="Mail Canada Post Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="capost_delivered",
    ),
    "capost_delivering": SensorEntityDescription(
        name="Mail Canada Post Delivering V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
        key="capost_delivering",
    ),
    "capost_packages": SensorEntityDescription(
        name="Mail Canada Post Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="capost_packages",
    ),
    ...
    "dhl_delivered": SensorEntityDescription(
        name="Mail DHL Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="dhl_delivered",
    ),
    "dhl_delivering": SensorEntityDescription(
        name="Mail DHL Delivering V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
        key="dhl_delivering",
    ),
    "dhl_packages": SensorEntityDescription(
        name="Mail DHL Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="dhl_packages",
    ),
    ...
    "hermes_delivered": SensorEntityDescription(
        name="Mail Hermes Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="hermes_delivered",
    ),
    "hermes_delivering": SensorEntityDescription(
        name="Mail Hermes Delivering V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
        key="hermes_delivering",
    ),
    "hermes_packages": SensorEntityDescription(
        name="Mail Hermes Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="hermes_packages",
    ),
    ...
    "royal_delivered": SensorEntityDescription(
        name="Mail Royal Mail Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="royal_delivered",
    ),
    "royal_delivering": SensorEntityDescription(
        name="Mail Royal Mail Delivering V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
        key="royal_delivering",
    ),
    "royal_packages": SensorEntityDescription(
        name="Mail Royal Mail Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="royal_packages",
    ),
    ...
    "auspost_delivered": SensorEntityDescription(
        name="Mail AusPost Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant",
        key="auspost_delivered",
    ),
    "auspost_delivering": SensorEntityDescription(
        name="Mail AusPost Delivering V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
        key="auspost_delivering",
    ),
    "auspost_packages": SensorEntityDescription(
        name="Mail AusPost Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
    ...
    "poczta_polska_delivering": SensorEntityDescription(
        name="Mail Poczta Polska Delivering V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
        key="poczta_polska_delivering",
    ),
    "poczta_polska_packages": SensorEntityDescription(
        name="Mail Poczta Polska Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
    ...
    "inpost_pl_delivering": SensorEntityDescription(
        name="Mail InPost.pl Delivering V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
        key="inpost_pl_delivering",
    ),
    "inpost_pl_delivered": SensorEntityDescription(
        name="Mail InPost.pl Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant",
        key="inpost_pl_delivered",
    ),
    "inpost_pl_packages": SensorEntityDescription(
        name="Mail InPost.pl Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
    ...
    "dpd_com_pl_delivering": SensorEntityDescription(
        name="Mail DPD.com.pl Delivering V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
        key="dpd_com_pl_delivering",
    ),
    "dpd_com_pl_delivered": SensorEntityDescription(
        name="Mail DPD.com.pl Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant",
        key="dpd_com_pl_delivered",
    ),
    "dpd_com_pl_packages": SensorEntityDescription(
        name="Mail DPD.com.pl Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
    ...
    "gls_delivering": SensorEntityDescription(
        name="Mail GLS Delivering V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
        key="gls_delivering",
    ),
    "gls_delivered": SensorEntityDescription(
        name="Mail GLS Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant",
        key="dpd_com_pl_delivered", # This key seems like a typo in original, should be gls_delivered
    ),
    "gls_packages": SensorEntityDescription(
        name="Mail GLS Packages V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant-closed",
        key="gls_packages",
    ),
    "zpackages_delivered": SensorEntityDescription(
        name="Mail Packages Delivered V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:package-variant",
        key="zpackages_delivered",
    ),
    "zpackages_transit": SensorEntityDescription(
        name="Mail Packages In Transit V2", # Changed for V2
        native_unit_of_measurement="package(s)",
        icon="mdi:truck-delivery",
...
IMAGE_SENSORS: Final[dict[str, SensorEntityDescription]] = {
    "usps_mail_image_system_path": SensorEntityDescription(
        name="Mail Image System Path V2", # Changed for V2
        icon="mdi:folder-multiple-image",
        key="usps_mail_image_system_path",
        entity_category=EntityCategory.DIAGNOSTIC,
    ),
    "usps_mail_image_url": SensorEntityDescription(
        name="Mail Image URL V2", # Changed for V2
...
# Name
CAMERA_DATA = {
    "usps_camera": ["Mail USPS Camera V2"], # Changed for V2
    "amazon_camera": ["Mail Amazon Delivery Camera V2"], # Changed for V2
}

# Sensor Index (may not be needed if we move away from this structure)
SENSOR_NAME = 0
SENSOR_UNIT = 1
SENSOR_ICON = 2
...
# Required for V2 IMAP client
IMAP_EXCEPTIONS = (
    imaplib.IMAP4.abort,
    imaplib.IMAP4.error,
    imaplib.IMAP4.readonly,
    TimeoutError, # Added for socket timeouts
)
