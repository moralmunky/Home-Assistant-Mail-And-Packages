...
SENSOR_DATA = {
    ...
    "dhl_delivered": {
        ...
        "subject": [
            ...
            # German DHL patterns from email analysis
    ...
    "dhl_packages": {},
    "dhl_tracking": {"pattern": ["\\d{10,11}", "DE[0-9]{10,}", "[0-9]{20}"]},
    # AliExpress
    ...
    "aliexpress_packages": {},
    "aliexpress_tracking": {"pattern": ["[A-Z]{2}[0-9]{9}[A-Z]{2}", "[0-9]{13}", "[0-9]{20}"]},
    # Hermes.co.uk
    "hermes_delivered": {
