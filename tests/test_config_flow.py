...
@pytest.mark.asyncio
async def test_reconfigure_allow_forwarded_emails_without_amazon_or_custom_img(
    input_1,
    step_id_2,
    input_2,
    step_id_3,
    ...
    data,
    hass: HomeAssistant,
    integration_forwarded_emails_no_amazon,
    mock_imap_no_email,
) -> None:
    """Test reconfigure flow."""
    entry = integration_forwarded_emails_no_amazon
